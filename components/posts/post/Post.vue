  ...
  <div>
    <div class="bg-white border mb-5 mt-5">
      ...
      <div class="flex px-3 py-2">
        <div class="w-5/6 flex-wrap flex items-center">
          <a href="#" class="inline-flex mr-5 text-gray-700 font-semibold hover:text-purple-600">
            <img src="https://api.adorable.io/avatars/40/1.png" alt="Название #1" class="h-6 mr-2">
            Название #1
          </a>
          <a href="#" class="inline-flex mr-5 text-sm text-gray-700 hover:text-purple-600">
            Имя Автора
          </a>
          <span class="inline-flex mr-5 text-sm text-gray-500" title="17 декабря 2019 15:25">
            {{ formatDate("2019-12-10 07:56:40") }}
          </span>
          <span class="inline-flex text-sm text-gray-500 items-center" title="Просмотров">
          <svg class="h-4 w-4 text-gray-500 fill-current mr-1" version="1.1" xmlns="http://www.w3.org/2000/svg"
               xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
               viewBox="0 0 489.658 489.658" style="enable-background:new 0 0 489.658 489.658;"
               xml:space="preserve">
              <path
                d="M194.829,244.829c0,27.57,22.43,50,50,50s50-22.43,50-50s-22.43-50-50-50S194.829,217.259,194.829,244.829z"/>
      ...
      <div class="flex items-center px-3 py-2">
        <h1 class="font-semibold text-2xl text-gray-800">Occaecati rem et eligendi adipisci facere et et voluptatem odit
          consequatur.</h1>
      </div>
      ...
      <div class="flex items-center px-3 py-2 text-gray-700">
        <p>
          ...
          necessitatibus quibusdam? Debitis ipsum itaque magnam nisi porro praesentium rem repellat tempore! Nulla,
          officiis, similique.
        </p>
      </div>
      ...
      <div class="px-3 py-2 text-gray-700">
        <p class="mb-3">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus aliquid architecto deleniti dolores esse
