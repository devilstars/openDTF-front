      ...
      <main class="flex flex-col items-center justify-center h-full w-full">
        <transition name="fade-up-down">
          <div v-if="showModal" class="modal-wrapper w-full max-w-2xl items-center z-30 p-3">
            <div class="modal min-w-full max-w-2xl bg-white max-h-screen shadow-lg flex-row rounded relative overflow-hidden">

              <div class="modal-header px-5 py-3 bg-gray-200 border-b-2 rounded-t flex items-start">
                <h5 class="text-black-500 text-xl uppercase">Вход</h5>
                <button class="ml-auto mt-2 text-gray-500 hover:text-purple-500"
                        @click="setShowModalOutside">
                  <svg class="h-4 w-4 fill-current" viewBox="0 0 329.26933 329" xmlns="http://www.w3.org/2000/svg">
